...
document.querySelector('.chat-header').style.backgroundColor = colorHeader;
...
style.innerHTML = `
  ...
  .chat-header { background-color: ${colorHeader} !important; }
`;
...
function showNextBatch() {
  ...
  const interval = setInterval(() => {
    ...
    if (line.startsWith('A:')) {
      ...
      Object.assign(avatar.style, { width: '90px', height: '90px', borderRadius: '50%', marginRight: '10px' });
